...
public class Maths {
    ...
    public static byte HashCoordinates(final double x, final double y, final int seed) {
        final double[] d = { x, y, seed };
        return XORFoldHash(FNV32Buffer(d, DOUBLE_SIZE * 3));
    }
    
    public static byte HashCoordinates(final double x, final double y, final double z, final int seed) {
        final double[] d = { x, y, z, seed };
        return XORFoldHash(FNV32Buffer(d, DOUBLE_SIZE * 4));
    }
    
    public static byte HashCoordinates(final double x, final double y, final double z, final double w, final int seed) {
        final double[] d = { x, y, z, w, seed };
        return XORFoldHash(FNV32Buffer(d, DOUBLE_SIZE * 5));
    }
    
    public static byte HashCoordinates(final double x, final double y, final double z, final double w, final double u,
