...
namespace TinkerWorX.AccidentalNoiseLibrary
{
    ...
    {
        private final ImplicitBasisFunction[] basisFunctions = new ImplicitBasisFunction[Noise.MAX_SOURCES];

        private final ImplicitModuleBase[] sources = new ImplicitModuleBase[Noise.MAX_SOURCES];

        private final double[] expArray = new double[Noise.MAX_SOURCES];

        private final double[,] correct = new double[Noise.MAX_SOURCES, 2];
